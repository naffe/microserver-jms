...
import microserver.jms.data.JmsSimulationMessageText
...
class ActiveMQEmbeddedTestSpecification extends Specification {
    ...
    def "Send single text message on queue"() {
        ...
        message.content == randomTextToSend
        cleanup:
        embeddedServer.stop()
    ...
    def "Send single byte message on queue"() {
        ...
        then: "Make sure all the properties are correct"
        message.content == randomByteToSend
        cleanup:
        embeddedServer.stop()
        receivingClient.stop()
    }
    ...
    def "Send single object message on queue"() {
        ...
        then: "Make sure all the properties are correct"
        message.content == randomObjectToSend
        cleanup:
        embeddedServer.stop()
        receivingClient.stop()
    }
    ...
    def "Send single map message on queue"() {
        ...
        then: "Make sure all the properties are correct"
        message.content == randomMapToSend
        cleanup:
        embeddedServer.stop()
        receivingClient.stop()
    }
